...
This document describes how to copy and customise the Humboldt3 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on humboldt3 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of humboldt3.
...
underscores. For the purpose of this tutorial we will call the theme 'humboldt3theme'.

On opening 'humboldt3theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case humboldt3. So using the above list as
a guide, search through and change all the instances of the theme name
'humboldt3' to 'humboldt3theme'. This includes the filename of the lang/en/theme_humboldt.php.
You need to change this to 'theme_humboldttheme.php'.
...
and then click on (Humboldt3theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the Humboldt3 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > Humboldt3

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/Humboldt3_theme
